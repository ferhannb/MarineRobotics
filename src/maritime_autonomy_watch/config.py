...
DAILY_MAX_ITEMS_PER_CATEGORY = int(os.getenv("MARITIME_WATCH_DAILY_MAX_ITEMS_PER_CATEGORY", "15"))
...
DEDUPLICATION_METHOD = (
    "DOI, canonical URL, source ID, normalized title, similar recent titles, category caps, and novelty score"
)
